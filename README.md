...
### 6. Cosmidex Logo - Made in [Canva](https://www.canva.com/)
### 7. Medal Icon - [Magnific - FLATICON](https://www.flaticon.com/authors/magnific)

Note for stardance reviewer - I changed the only ai generated Art that I used in the app, It was an AI generated Logo, but I made my own logo in canva without using any AI, earlier it was a wikimedia image but I didnt like it so made my own, I also changed the banner for stardance project to a screenshot of the app, please accept the project now :(