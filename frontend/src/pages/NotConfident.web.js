...
const NotConfident = ({ setPokemon }) => {
    ...
    return (
        <View className="flex-1 justify-center items-center">
            ...
            <View className="flex-1 mt-36 mb-20 w-[70%] bg-[#0C1125] rounded-xl h-max-[30%] pb-10 px-4">
                ...
                </View> : <View className="flex-1 flex-row gap-3 px-4 mt-6">
                    {pokemonDetails.map((p, index) => (
                        ...
                        >
                            ...
                            <View className="flex-1 ml-4">
                                <Text className="text-[#79E7B8] font-bold text-lg text-center">{p.displayName}</Text>
